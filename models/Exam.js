...
const examQuestionSchema = new mongoose.Schema({
    ...
    timeLimitSeconds: { type: Number } // Question-wise timer
}, { _id: false });
...
const examSectionSchema = new mongoose.Schema({
    ...
    durationSeconds: { type: Number, default: 0 }, // Sectional timer
...
const examSchema = new mongoose.Schema({
    ...
    proctoring: {
        durationMinutes: { type: Number, required: true }, // Total timer
        startTime: { type: Date },
        endTime: { type: Date },
